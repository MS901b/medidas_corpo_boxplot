...
var Questoes = [{ //Parte 1
        parte1_q1: //Questão 1
        {
            enunciadoGeral: 'De acordo com as <a href="#" onclick="BlocoNotas.abre(); event.returnValue = false;  return false;">medidas resumos</a> da sua amostra, posicione os segmentos de forma que o box plot ao lado represente a amostra de alturas das meninas.',
            itens: [{ //A
                    tipo: 'instrucao',
                    corrigir: corrige_q_1_a,
                    enunciado: 'Posicione o segmento que representa o mínimo da amostra.',
                    msgErro: 'Observe o valor de mínimo na tabela do bloco de notas e posicione o segmento correspondente movendo o <a id="ponto_verde_erro_a">ponto</a> em destaque no quadro ao lado.',
                ...
                { //B
                    ...
                    msgErro: 'Observe o valor de máximo na tabela do bloco de notas e posicione o segmento correspondente, movendo o <a id="ponto_verde_erro_b">ponto</a> em destaque no quadro ao lado.'
                },
                { //C
                    tipo: 'instrucao',
                    corrigir: corrige_q_1_c,
                    enunciado: 'Posicione o segmento que representa o quantil 25% da amostra.',
                    msgErro: 'Observe o valor do quantil 25% na tabela do bloco de notas e posicione o segmento correspondente movendo o <a id="ponto_verde_erro_c">ponto</a> em destaque no quadro ao lado.'
                },
                { //D
                    tipo: 'instrucao',
                    corrigir: corrige_q_1_d,
                    enunciado: 'Posicione o segmento que representa o quantil 75% da amostra.',
                    msgErro: 'Observe o valor do quantil 75% na tabela do bloco de notas e posicione o segmento correspondente movendo o <a id="ponto_verde_erro_d">ponto</a> em destaque no quadro ao lado.'
                },
                { //E
                    tipo: 'instrucao',
                    corrigir: corrige_q_1_e,
                    enunciado: 'Por fim, posicione o segmento que representa a mediana da amostra.',
                    msgErro: 'Observe o valor da mediana na tabela do bloco de notas e posicione o segmento correspondente movendo o <a id="ponto_verde_erro_e">ponto</a> em destaque no quadro ao lado.'
                }
            ]
        }
    },
    { //Parte 2
        parte2_q2: //Questão 2
        {
            enunciadoGeral: 'Posicione os segmentos de forma que o box plot ao lado represente as alturas dos meninos da amostra.',
            itens: [{ //A
                    tipo: 'instrucao',
    ...
    { //Parte 3
        parte3_q3: //Questão 3
        {
            ...
            itens: [{ //A
                    ...
                    enunciado: 'Qual dos dois grupos tem a maior altura?',
                    dados: [
                ...
                { //B
                    ...
                    enunciado: 'Qual dos dois grupos tem a menor altura?',
                    dados: [
                        { value: 'm', label: 'Masculino' },
                        { value: 'f', label: 'Feminino' },
                        { value: 'i', label: 'Iguais' }
                ...
                { //C
                    ...
                    msgErro: 'Você pode obter essa informação observando os gráficos no quadro ao lado. Para certificar-se de qual segmento representa a mediana, basta olhar o exemplo de box plot na referência 2.'
                }
            ]
        },
        parte3_q4: //Questão 4
        {
            ...
            itens: [{ //A
                ...
                { //B
                    ...
                    msgErro: 'Você precisa dos valores de altura correspondentes aos quantis 25% e 75% do grupo mais concentrado.',
                ...
                { //C
                    ...
                    msgAjuda: 'Observe a diferença entre os valores de máximo e mínimo de cada um dos gráficos.'
                },
                { //D
                    tipo: 'input',
